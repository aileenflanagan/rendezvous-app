					...
					<div id="carouselExampleCaptions" className="carousel slide" data-ride="carousel">
						...
						<div className="carousel-inner">
							<div className="carousel-item active">
								<img src="images/people-working.jpg" id="caro" className="d-block w-100" alt="..." />
							...
							<div className="carousel-item">
								<img src="images/awesome_720.jpg" id="caro" className="d-block w-100" alt="..." />
								<div className="carousel-caption d-none d-md-block">
							...
							<div className="carousel-item">
								<img src="images/people-exercising.jpg" id="caro" className="d-block w-100" alt="..." />
								<div className="carousel-caption d-none d-md-block">
